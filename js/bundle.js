...
(() => {
  var t = {
      ...
      217: (t, e, i) => {
        var n, s;
        !(function (o, r) {
          (n = [i(158), i(131), i(47), i(229), i(714), i(880)]),
                ...
                (f.setCellAlign = function () {
                  ...
                  (f.watchCSS = function () {
                    this.options.watchCSS &&
                      (-1 !=
                      h(this.element, ":after").content.indexOf("flickity")
                        ? this.activate()
                        : this.deactivate());
                  }),
      ...
      442: (t, e, i) => {
        var n, s, o;
        window,
          (s = [i(217), i(690), i(410), i(573), i(516), i(597), i(227)]),
          void 0 ===
            (o =
              "function" ==
              typeof (n = function (t) {
              ...
              typeof (n = function () {
                ...
                function c(e) {
                  if (
                    ...
                    for (
                      var c = (h.isBorderBox = "border-box" == i.boxSizing),
                        d = 0;
                      d < s;
                      d++
                    ) {
  ...
  (i.r = (t) => {
    ...
    (() => {
      ...
      function a(e) {
        return new t("#" + e, { imagesLoaded: !0, adaptiveHeight: !0 });
      }
      function h(t) {
            ...
            !(function (t) {
              ...
              if (document.querySelector("#" + s)) {
                if (0 === e.length) e.push(a(s));
                  ...
                  -1 === e.findIndex((t) => t.element.id == s) && e.push(a(s));
              }
            })(t.dataset.target);
          });
        }),
